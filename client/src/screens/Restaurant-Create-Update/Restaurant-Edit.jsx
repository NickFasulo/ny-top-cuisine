...
export default function Edit() {
  ...
  const fetchRestaurant = async() => {
    ...
    setCuisine((prev) => ({
        ...prev,
        cuisine1:oneRest.cuisines[0],cuisine2:oneRest.cuisines[1],cuisine3:oneRest.cuisines[2],cuisine4:oneRest.cuisines[3]
      }));
    setAddresS((prev) => ({
    ...prev,
    addy:oneRest.address.zipcode, location:oneRest.address.city, zip:oneRest.address.street_addr
    }));
    setHours((prev) => ({
        ...prev,
        Monday:oneRest.local_hours.operational.Monday,Tuesday:oneRest.local_hours.operational.Tuesday,Wednesday:oneRest.local_hours.operational.Wednesday,Thursday:oneRest.local_hours.operational.Thursday,Friday:oneRest.local_hours.operational.Friday,Saturday:oneRest.local_hours.operational.Saturday,Sunday:oneRest.local_hours.operational.Sunday
      }));  
}
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    let response = await updateRestaurant(id, restaurant);
  ...
  return (
    <div className="background">
        <h1 className='createTitle'>Update Restaurant!</h1>
